      ...
      <td width="500" valign="top"><table width="500"  border="0" cellspacing="0" cellpadding="0">
		...
		<font color="red">
 		...
 		<table class="table table-bordered table-hover" align="center" border="1">
 			<tr>
 				<th>厂家编号</th><th>厂家名称</th><th>负责人</th><th>联系电话</th><th>工厂地址</th>
 			</tr>
 			<%
 				for(Manufacturer u:users){
 			 					out.println("<tr>");
 			 						...
 			 						out.println("<td><a href=\"Manufacturer//deleteManufacturer.do?ID="+u.getID()+"\">删除</a></td>");
 			 						out.println("<td><a href=\"Manufacturer//findManufacturer.do?ID="+u.getID()+"\">更新</a></td>");
 			 					out.println("</tr>");
 			 				}
 			%>
 		</table>
